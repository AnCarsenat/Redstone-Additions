...
data modify entity @e[type=marker,tag=ra.custom_block.ender_item_vault,tag=ra.new,distance=..0.5,sort=nearest,limit=1] data.properties.mode set value "shared"
