# /ra_ender:blocks/power_vault/cycle_mode
...
execute if score #ender.mode ra.temp matches 0 run tellraw @a[distance=..10] [{text:"[Wrench] ",color:"gold"},{text:"Ender Power Vault: ",color:"gray"},{text:"send",color:"green"}]
execute if score #ender.mode ra.temp matches 1 run tellraw @a[distance=..10] [{text:"[Wrench] ",color:"gold"},{text:"Ender Power Vault: ",color:"gray"},{text:"receive",color:"aqua"}]
execute if score #ender.mode ra.temp matches 2 run tellraw @a[distance=..10] [{text:"[Wrench] ",color:"gold"},{text:"Ender Power Vault: ",color:"gray"},{text:"link (two-way)",color:"light_purple"}]
