# /ra_gates:blocks/randomizer/goggles
...
data modify storage ra:temp block_name set value "Randomizer"
...
function ra:tools/goggles/billboard/prop_line {path:"chance",label:"Chance: ",color:"aqua",suffix:"%",y:0.8}
