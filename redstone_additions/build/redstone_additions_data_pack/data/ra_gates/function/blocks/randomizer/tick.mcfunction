...
tag @e[type=marker,tag=ra.broken,tag=ra.custom_block.randomizer] remove ra.broken

# Process randomizer logic
execute as @e[type=marker,tag=ra.custom_block.randomizer] at @s run function ra_gates:blocks/randomizer/process
