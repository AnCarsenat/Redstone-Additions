...
summon item ~ ~ ~ {Item:{id:"minecraft:bat_spawn_egg",count:1,components:{"minecraft:item_model":"minecraft:smooth_stone_slab","minecraft:item_name":"UNI Gate","minecraft:custom_data":{ra:{uni_gate:1b}},"minecraft:entity_data":{id:"minecraft:bat",Tags:["ra","ra.spawned","ra.place.uni_gate"],Silent:1b,NoAI:1b,Invulnerable:1b}}},Tags:["ra","ra.drop_temp"]}
kill @s
