...
execute as @e[type=marker,tag=ra.broken,tag=ra.custom_block.block_placer] at @s run execute if data block ~ ~ ~ Items[0] run summon item ~ ~0.5 ~ {Tags:["ra","ra.drop_temp"]}
