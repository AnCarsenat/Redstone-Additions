# /ra_interactive:blocks/message_block/goggles
...
data modify storage ra:temp block_name set value "Message Block"
...
function ra:tools/goggles/billboard/prop_line {path:"message_block",label:"Text: ",color:"aqua",suffix:"",y:0.8}
