...
particle minecraft:flame ~ ~-0.3 ~ 0.55 0.25 0.55 0.04 10 normal @a[scores={ra.u.par=1..}]
particle minecraft:small_flame ~ ~-0.5 ~ 0.65 0.4 0.65 0.04 8 normal @a[scores={ra.u.par=1..}]
...
particle minecraft:flame ~ ~-2.0 ~ 0.75 0.8 0.75 0.02 7 normal @a[scores={ra.u.par=1..}]
particle minecraft:small_flame ~ ~-4.5 ~ 0.95 1.2 0.95 0.02 6 normal @a[scores={ra.u.par=1..}]
