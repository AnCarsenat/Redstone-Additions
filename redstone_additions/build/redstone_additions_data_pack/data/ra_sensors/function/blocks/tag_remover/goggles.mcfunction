# /ra_sensors:blocks/tag_remover/goggles
...
data modify storage ra:temp block_name set value "Tag Remover"
...
function ra:tools/goggles/billboard/prop_line {path:"tag",label:"Tag: ",color:"aqua",suffix:"",y:0.8}
