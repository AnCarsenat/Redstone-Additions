# /ra_wireless:blocks/receiver/goggles
...
data modify storage ra:temp block_name set value "Wireless Receiver"
...
function ra:tools/goggles/billboard/prop_line {path:"channel",label:"Channel: ",color:"aqua",suffix:"",y:0.8}
