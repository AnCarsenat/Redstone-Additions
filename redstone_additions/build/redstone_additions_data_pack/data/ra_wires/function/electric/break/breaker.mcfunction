...
summon item ~ ~ ~ {Item:{id:"minecraft:bat_spawn_egg",count:1,components:{"minecraft:item_model":"minecraft:waxed_copper_bulb","minecraft:item_name":'EU Breaker',"minecraft:lore":[{text:"Powered: evens EU between the grids",color:"gray",italic:false},{text:"on either side. Never merges them.",color:"gray",italic:false}],"minecraft:custom_data":{ra:{electric_breaker:1b}},"minecraft:entity_data":{id:"minecraft:bat",Tags:["ra.spawned","ra.place.electric_breaker"],Silent:1b,NoAI:1b,Invulnerable:1b}}}}
kill @s
