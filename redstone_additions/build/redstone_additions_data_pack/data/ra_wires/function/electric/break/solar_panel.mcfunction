...
summon item ~ ~ ~ {Item:{id:"minecraft:bat_spawn_egg",count:1,components:{"minecraft:item_model":"minecraft:daylight_detector","minecraft:item_name":'Solar Panel',"minecraft:lore":[{text:"Generates EU from sunlight",color:"gray",italic:false}],"minecraft:custom_data":{ra:{solar_panel:1b}},"minecraft:entity_data":{id:"minecraft:bat",Tags:["ra","ra.spawned","ra.place.solar_panel"],Silent:1b,NoAI:1b,Invulnerable:1b}}}}
kill @s
