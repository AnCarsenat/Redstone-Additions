...
execute if score #net_amount ra.tr.tmp matches ..4999 run data modify entity @s data.status.drain_state set value "not_enough"
execute if score #net_amount ra.tr.tmp matches ..4999 run return 0
