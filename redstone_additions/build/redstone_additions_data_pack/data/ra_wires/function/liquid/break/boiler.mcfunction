...
summon item ~ ~ ~ {Item:{id:"minecraft:bat_spawn_egg",count:1,components:{"minecraft:item_model":"minecraft:furnace","minecraft:item_name":'Boiler',"minecraft:custom_data":{ra:{boiler:1b}},"minecraft:entity_data":{id:"minecraft:bat",Tags:["ra.spawned","ra.place.boiler"],Silent:1b,NoAI:1b,Invulnerable:1b}}}}
kill @s
