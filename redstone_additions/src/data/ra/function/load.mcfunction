...
# Redstone Additions v5.1.5 - Core Load
...
# ========================== WELCOME MESSAGE ==========================
# Load message_block
tellraw @a [{text:"[RA_Lib] ",color:"gold"},{text:"v5.1.5 loaded",color:"green"}]

# Welcome message_block
tellraw @a [{text:"[",color:"dark_gray"},{text:"RA",color:"gold",bold:true},{text:"] ",color:"dark_gray"},{text:"Redstone Additions v5.1.5 loaded!",color:"green"}]
