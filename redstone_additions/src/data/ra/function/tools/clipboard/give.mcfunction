...
give @s minecraft:paper[item_model="minecraft:paper",item_name="Clipboard",lore=[{text:"Shift+RMB a block: set it as the origin",italic:false,color:"gray"},{text:"Shift+RMB others: match them to it",italic:false,color:"gray"},{text:"Shift+RMB at nothing: clear",italic:false,color:"gray"}],max_stack_size=1,custom_data={ra:{clipboard:1b}},enchantment_glint_override=true,food={nutrition:0,saturation:0,can_always_eat:true},consumable={consume_seconds:1000000,animation:"none",has_consume_particles:false}]
