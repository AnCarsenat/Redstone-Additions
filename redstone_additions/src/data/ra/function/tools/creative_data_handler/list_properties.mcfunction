...
execute if data entity @e[type=marker,tag=ra.cdh_target,limit=1] data.properties.cooldown run function ra:tools/creative_data_handler/props/show_cooldown
