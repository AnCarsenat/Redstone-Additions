...
tag @e[type=marker,tag=ra.cdh_target] remove ra.cdh_target
...
execute at @s anchored eyes positioned ^ ^ ^1 as @e[type=marker,tag=ra.custom_block,distance=..1.5,limit=1,sort=nearest] run function ra:tools/creative_data_handler/found_block
execute at @s anchored eyes positioned ^ ^ ^2 unless data storage ra:temp cdh_found as @e[type=marker,tag=ra.custom_block,distance=..1.5,limit=1,sort=nearest] run function ra:tools/creative_data_handler/found_block
execute at @s anchored eyes positioned ^ ^ ^3 unless data storage ra:temp cdh_found as @e[type=marker,tag=ra.custom_block,distance=..1.5,limit=1,sort=nearest] run function ra:tools/creative_data_handler/found_block
execute at @s anchored eyes positioned ^ ^ ^4 unless data storage ra:temp cdh_found as @e[type=marker,tag=ra.custom_block,distance=..1.5,limit=1,sort=nearest] run function ra:tools/creative_data_handler/found_block
