...
data modify storage ra:dh readonly set value {"block_breaker":{cooldown:1b},"block_placer":{cooldown:1b},"electric_breaker":{rate:1b},"electric_consumer":{eu_use:1b},"electric_generator":{generation_rate:1b},"ender_fluid_vault":{transfer_rate:1b},"ender_power_vault":{transfer_rate:1b},"gas_valve":{rate:1b},"industrial_light":{eu_use:1b},"liquid_filter":{rate:1b},"liquid_valve":{rate:1b},"mineral_generator":{cooldown:1b},"multiblock_base":{tier:1b,tier_level:1b},"nether_generator":{cooldown:1b},"poppy_generator":{cooldown:1b},"solar_panel":{generation_rate:1b}}
