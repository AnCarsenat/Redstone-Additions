...
execute at @s anchored eyes positioned ^ ^ ^1 as @e[type=marker,tag=ra.custom_block,distance=..1.5,limit=1,sort=nearest] run function ra:tools/wrench/found_block
execute at @s anchored eyes positioned ^ ^ ^2 unless data storage ra:temp wrench_found as @e[type=marker,tag=ra.custom_block,distance=..1.5,limit=1,sort=nearest] run function ra:tools/wrench/found_block
execute at @s anchored eyes positioned ^ ^ ^3 unless data storage ra:temp wrench_found as @e[type=marker,tag=ra.custom_block,distance=..1.5,limit=1,sort=nearest] run function ra:tools/wrench/found_block
execute at @s anchored eyes positioned ^ ^ ^4 unless data storage ra:temp wrench_found as @e[type=marker,tag=ra.custom_block,distance=..1.5,limit=1,sort=nearest] run function ra:tools/wrench/found_block
