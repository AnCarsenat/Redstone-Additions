...
data modify entity @e[type=item,tag=ra.ench.product,distance=..1.5,limit=1,sort=nearest] Item set from storage ra:enchant result
tag @e[type=item,tag=ra.ench.product,distance=..1.5,limit=1,sort=nearest] remove ra.ench.product
