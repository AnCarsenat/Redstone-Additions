# /ra_gates:blocks/delayer/goggles
...
data modify storage ra:temp block_name set value "Delayer"
...
function ra:tools/goggles/billboard/prop_line {path:"delay",label:"Delay: ",color:"aqua",suffix:"t",y:0.8}
