# /ra_gates:blocks/extender/goggles
...
data modify storage ra:temp block_name set value "Extender"
...
function ra:tools/goggles/billboard/prop_line {path:"extend",label:"Extend: ",color:"aqua",suffix:"t",y:0.8}
