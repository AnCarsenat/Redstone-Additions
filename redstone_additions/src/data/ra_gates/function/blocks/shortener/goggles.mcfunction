# /ra_gates:blocks/shortener/goggles
...
data modify storage ra:temp block_name set value "Shortener"
...
function ra:tools/goggles/billboard/prop_line {path:"pulse",label:"Pulse: ",color:"aqua",suffix:"t",y:0.8}
