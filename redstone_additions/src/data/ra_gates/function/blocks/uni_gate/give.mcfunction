...
give @s bat_spawn_egg[item_model="minecraft:smooth_stone_slab",item_name="UNI Gate",custom_data={ra:{uni_gate:1b}},entity_data={id:"minecraft:bat",Tags:["ra","ra.spawned","ra.place.uni_gate"],Silent:1b,NoAI:1b,Invulnerable:1b}]
