# /ra_gates:blocks/uni_gate/goggles
...
data modify storage ra:temp block_name set value "UNI Gate"
...
function ra:tools/goggles/billboard/prop_line {path:"gate_type",label:"Mode: ",color:"aqua",suffix:"",y:0.45}
