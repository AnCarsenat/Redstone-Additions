...
data modify entity @e[type=marker,tag=ra.custom_block.mineral_generator,tag=ra.new,distance=..0.5,sort=nearest,limit=1] data.properties.enabled set value 1b
