...
execute if data block ~ ~ ~ Items[0] run summon item ~ ~0.5 ~ {Tags:["ra","ra.drop_temp"]}
...
execute if data block ~ ~ ~ Items[1] run summon item ~ ~0.5 ~ {Tags:["ra","ra.drop_temp"]}
...
execute if data block ~ ~ ~ Items[2] run summon item ~ ~0.5 ~ {Tags:["ra","ra.drop_temp"]}
...
execute if data block ~ ~ ~ Items[3] run summon item ~ ~0.5 ~ {Tags:["ra","ra.drop_temp"]}
...
execute if data block ~ ~ ~ Items[4] run summon item ~ ~0.5 ~ {Tags:["ra","ra.drop_temp"]}
...
execute if data block ~ ~ ~ Items[5] run summon item ~ ~0.5 ~ {Tags:["ra","ra.drop_temp"]}
...
execute if data block ~ ~ ~ Items[6] run summon item ~ ~0.5 ~ {Tags:["ra","ra.drop_temp"]}
...
execute if data block ~ ~ ~ Items[7] run summon item ~ ~0.5 ~ {Tags:["ra","ra.drop_temp"]}
...
execute if data block ~ ~ ~ Items[8] run summon item ~ ~0.5 ~ {Tags:["ra","ra.drop_temp"]}
