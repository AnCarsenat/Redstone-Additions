...
function ra:tools/goggles/billboard/stacked_prop_line {path:"cooldown",label:"Cooldown: ",color:"aqua",suffix:" ticks"}
function ra:tools/goggles/billboard/stacked_data_line {path:"pulled",label:"Last pulse: ",color:"green",suffix:" items"}
