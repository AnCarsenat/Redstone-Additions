...
$execute positioned $(input1) run data modify storage ra:temp storage_box.target_box set value {id:"minecraft:command_block",count:1,components:{"minecraft:item_model":"minecraft:player_head","minecraft:custom_name":{text:"Item Crate",color:"white",italic:false},"minecraft:profile":"BoxMan01234","minecraft:max_stack_size":64,"minecraft:lore":[{text:"(empty)",color:"gray",italic:false}],"minecraft:custom_data":{ra:{item_box:1b,storage_box:{items:[],preview:[]}}}}}
