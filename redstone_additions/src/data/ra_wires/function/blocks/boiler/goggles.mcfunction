# /ra_wires:blocks/boiler/goggles
...
data modify storage ra:temp block_name set value "Boiler"
...
function ra:tools/goggles/billboard/data_line {path:"boiler_state",label:"Boiler: ",color:"gold",suffix:"",y:0.8}
