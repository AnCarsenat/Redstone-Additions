# /ra_wires:blocks/creative_eu/goggles
# Goggles readout, and the block's display name.
# Context: as the block's marker, at the block position.

data modify storage ra:temp block_name set value "Creative EU Source"
...
function ra:tools/goggles/billboard/stacked_status_line {path:"filled",label:"Filled: ",color:"yellow",suffix:" EU"}
