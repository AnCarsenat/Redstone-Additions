# /ra_wires:blocks/electric_generator/goggles
...
data modify storage ra:temp block_name set value "EU Generator"
...
function ra:tools/goggles/billboard/data_line {path:"available_eu",label:"EU: ",color:"aqua",suffix:"",y:0.8}
...
function ra:tools/goggles/billboard/data_line {path:"fuel",label:"Fuel: ",color:"gold",suffix:"",y:0.3}
