...
execute if entity @s[tag=ra.place.liquid_pump] run data modify storage ra:wires spec set value {block:"minecraft:dispenser",marker:"liquid_pump",dir:2,fluid:1b,net:"fluid",capacity:5000,props:{}}
...
execute if entity @s[tag=ra.place.electric_generator] run data modify storage ra:wires spec set value {block:"minecraft:barrel",marker:"electric_generator",electric:1b,net:"electric",dir:1,capacity:50,props:{}}
execute if entity @s[tag=ra.place.electric_consumer] run data modify storage ra:wires spec set value {block:"minecraft:observer",marker:"electric_consumer",electric:1b,net:"electric",capacity:50,props:{}}
execute if entity @s[tag=ra.place.solar_panel] run data modify storage ra:wires spec set value {block:"minecraft:daylight_detector",marker:"solar_panel",electric:1b,net:"electric",capacity:50,props:{}}
execute if entity @s[tag=ra.place.electric_switch] run data modify storage ra:wires spec set value {block:"minecraft:waxed_cut_copper",marker:"electric_switch",electric:1b,net:"electric",capacity:0,props:{}}
...
execute if entity @s[tag=ra.place.boiler] run data modify storage ra:wires spec set value {block:"minecraft:furnace",marker:"boiler",props:{}}
