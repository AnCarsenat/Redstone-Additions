# /ra_wires:blocks/liquid_pump/goggles
...
data modify storage ra:temp block_name set value "Liquid Pump"
...
function ra:tools/goggles/billboard/data_line {path:"pump_state",label:"Pump: ",color:"gray",suffix:"",y:0.3}
