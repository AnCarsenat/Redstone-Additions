...
function ra:tools/goggles/billboard/data_line {path:"available_eu",label:"EU: ",color:"aqua",suffix:"",y:0.45}
function ra:tools/goggles/billboard/data_line {path:"fuel",label:"Light: ",color:"gold",suffix:"",y:0.2}
