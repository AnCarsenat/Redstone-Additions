# /ra_wires:electric/break/consumer
# Clean up a broken consumer and return its item.
...
summon item ~ ~ ~ {Item:{id:"minecraft:bat_spawn_egg",count:1,components:{"minecraft:item_model":"minecraft:observer","minecraft:item_name":'EU Consumer',"minecraft:custom_data":{ra:{electric_consumer:1b}},"minecraft:entity_data":{id:"minecraft:bat",Tags:["ra","ra.spawned","ra.place.electric_consumer"],Silent:1b,NoAI:1b,Invulnerable:1b}}}}
kill @s
