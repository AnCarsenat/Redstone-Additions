...
function ra_wires:blocks/industrial_light/cast {mode:0}
...
summon item ~ ~ ~ {Item:{id:"minecraft:bat_spawn_egg",count:1,components:{"minecraft:item_model":"minecraft:sea_lantern","minecraft:item_name":'Industrial Light',"minecraft:lore":[{text:"Redstone + EU: a 10 block beam of light",color:"gray",italic:false}],"minecraft:custom_data":{ra:{industrial_light:1b}},"minecraft:entity_data":{id:"minecraft:bat",Tags:["ra","ra.spawned","ra.place.industrial_light"],Silent:1b,NoAI:1b,Invulnerable:1b}}}}
kill @s
