...
data modify storage ra:wires fuels set value [{item:"minecraft:coal_block",ticks:16000},{item:"minecraft:dried_kelp_block",ticks:4000},{item:"minecraft:blaze_rod",ticks:2400},{item:"minecraft:coal",ticks:1600},{item:"minecraft:charcoal",ticks:1600},{item:"minecraft:bamboo_mosaic",ticks:300},{item:"minecraft:oak_planks",ticks:300},{item:"minecraft:spruce_planks",ticks:300},{item:"minecraft:birch_planks",ticks:300},{item:"minecraft:jungle_planks",ticks:300},{item:"minecraft:acacia_planks",ticks:300},{item:"minecraft:dark_oak_planks",ticks:300},{item:"minecraft:oak_log",ticks:300},{item:"minecraft:spruce_log",ticks:300},{item:"minecraft:birch_log",ticks:300},{item:"minecraft:stick",ticks:100}]
