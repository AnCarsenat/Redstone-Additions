...
execute if data storage ra:temp upgrade.result run data modify storage ra:temp upgrade.chance set value 50
...
execute if data storage ra:temp upgrade.result run data modify storage ra:temp upgrade.chance set value 33
execute if data storage ra:temp upgrade.result run return 1
...
execute if data storage ra:temp upgrade.result run data modify storage ra:temp upgrade.chance set value 5
execute if data storage ra:temp upgrade.result run return 1
