...
# Liquid tank
execute if entity @s[tag=ra.place.liquid_tank] run function ra_lib:placement/place {block_id:"minecraft:copper_block",block_tag:"liquid_tank",dir_type:0}
...
# Liquid valve
execute if entity @s[tag=ra.place.liquid_valve] run function ra_lib:placement/place {block_id:"minecraft:cut_copper",block_tag:"liquid_valve",dir_type:0}
...
execute if entity @s[tag=ra.place.electric_wire_copper] run function ra_lib:placement/place {block_id:"minecraft:mud_brick_wall",block_tag:"electric_wire",dir_type:0}
...
execute if entity @s[tag=ra.place.electric_wire_netherite] run function ra_lib:placement/place {block_id:"minecraft:polished_blackstone_wall",block_tag:"electric_wire",dir_type:0}
